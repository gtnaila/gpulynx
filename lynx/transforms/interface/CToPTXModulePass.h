...
namespace transforms
{
	...
	{			
		...
		public:
            ...
            CToPTXModulePass(std::string functionName, ir::PTXKernel::PTXStatementVector globals);
            CToPTXModulePass(ir::PTXKernel::PTXStatementVector globals);

            Pass::StringVector getDependentPasses() const;
