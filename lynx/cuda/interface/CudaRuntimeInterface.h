/*! \file CudaRuntimeInterface.h
	...
	\brief The header file for the CUDA Runtime Interface
*/

#ifndef __CUDA_RUNTIME_INTERFACE_H_
#define __CUDA_RUNTIME_INTERFACE_H_
 ...
 */
class CudaRuntimeInterface : boost::noncopyable {
public:
