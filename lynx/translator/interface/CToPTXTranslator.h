...
#define GLOBAL_MEM_BASE_ADDRESS "__lynx_global_mem_base_address__"
#define BASE_ADDRESS "__lynx_mem_base_address__"
...
#define ON_FLOATING_POINT   "FLOATING_POINT_INSTRUCTION"
#define ON_TEXTURE          "TEXTURE_INSTRUCTION"
	...
	*/
	class CToPTXTranslator
	{
		...
		public:
            ...
            static CToPTXTranslator & translator();
            virtual ~CToPTXTranslator();
            CToPTXTranslator();
