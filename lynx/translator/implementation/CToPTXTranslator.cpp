...
#include <lynx/translator/interface/CToPTXInterface.h>
...
namespace translator
{
    ...
    static CToPTXTranslator _instance;
    CToPTXTranslator & CToPTXTranslator::translator() {
        return _instance;
    }
    ...
    int CToPTXTranslator::translate(dill_stream c, void *info_ptr, void *i)
    {
        ...
        case iclass_lea:
        {
            ...
            if(baseAddressId == "103")
            {
                ...
                shared.name = BASE_ADDRESS + baseAddressId;
                shared.array.stride = ir::PTXStatement::ArrayStrideVector(1, SHARED_MEM_SIZE);
                shared.alignment = 64;
                shared.type = type;
            ...
            global.name = GLOBAL_MEM_BASE_ADDRESS;
            global.type = type;
