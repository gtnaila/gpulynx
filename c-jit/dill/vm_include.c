...
void emulate_arith3(int code, struct reg_type *dest, struct reg_type *src1, struct reg_type *src2)
{
    switch(code) {
	  ...
	  case dill_jmp_addp:  dest->u.p.p = (char*) src1->u.p.p + (long) src2->u.p.p; break;
	  ...
	  case dill_jmp_subp:  dest->u.p.p = (char*) src1->u.p.p - (long) src2->u.p.p; break;
...
{
    switch(code) {
	  case dill_jmp_addi:  dest->u.i.i =  src1->u.i.i +  imm; break;
	  case dill_jmp_addu:  dest->u.u.u =  src1->u.u.u +  imm; break;
	  case dill_jmp_addul:  dest->u.ul.ul =  src1->u.ul.ul +  imm; break;
	  case dill_jmp_addl:  dest->u.l.l =  src1->u.l.l +  imm; break;
	  case dill_jmp_addp:  dest->u.p.p = (char*) src1->u.p.p + (long) imm; break;
	  case dill_jmp_subi:  dest->u.i.i =  src1->u.i.i -  imm; break;
	  case dill_jmp_subu:  dest->u.u.u =  src1->u.u.u -  imm; break;
	  case dill_jmp_subul:  dest->u.ul.ul =  src1->u.ul.ul -  imm; break;
	  case dill_jmp_subl:  dest->u.l.l =  src1->u.l.l -  imm; break;
	  case dill_jmp_subp:  dest->u.p.p = (char*) src1->u.p.p - (long) imm; break;
	  case dill_jmp_mulu:  dest->u.u.u =  src1->u.u.u *  imm; break;
	  case dill_jmp_mulul:  dest->u.ul.ul =  src1->u.ul.ul *  imm; break;
	  case dill_jmp_muli:  dest->u.i.i =  src1->u.i.i *  imm; break;
	  case dill_jmp_mull:  dest->u.l.l =  src1->u.l.l *  imm; break;
	  case dill_jmp_divu:  dest->u.u.u =  src1->u.u.u /  imm; break;
	  case dill_jmp_divul:  dest->u.ul.ul =  src1->u.ul.ul /  imm; break;
	  case dill_jmp_divi:  dest->u.i.i =  src1->u.i.i /  imm; break;
	  case dill_jmp_divl:  dest->u.l.l =  src1->u.l.l /  imm; break;
	  case dill_jmp_modu:  dest->u.u.u =  src1->u.u.u %  imm; break;
	  case dill_jmp_modul:  dest->u.ul.ul =  src1->u.ul.ul %  imm; break;
	  case dill_jmp_modi:  dest->u.i.i =  src1->u.i.i %  imm; break;
	  case dill_jmp_modl:  dest->u.l.l =  src1->u.l.l %  imm; break;
	  case dill_jmp_andi:  dest->u.i.i =  src1->u.i.i &  imm; break;
	  case dill_jmp_andu:  dest->u.u.u =  src1->u.u.u &  imm; break;
	  case dill_jmp_andul:  dest->u.ul.ul =  src1->u.ul.ul &  imm; break;
	  case dill_jmp_andl:  dest->u.l.l =  src1->u.l.l &  imm; break;
	  case dill_jmp_ori:  dest->u.i.i =  src1->u.i.i |  imm; break;
	  case dill_jmp_oru:  dest->u.u.u =  src1->u.u.u |  imm; break;
	  case dill_jmp_orul:  dest->u.ul.ul =  src1->u.ul.ul |  imm; break;
	  case dill_jmp_orl:  dest->u.l.l =  src1->u.l.l |  imm; break;
	  case dill_jmp_xori:  dest->u.i.i =  src1->u.i.i ^  imm; break;
	  case dill_jmp_xoru:  dest->u.u.u =  src1->u.u.u ^  imm; break;
	  case dill_jmp_xorul:  dest->u.ul.ul =  src1->u.ul.ul ^  imm; break;
	  case dill_jmp_xorl:  dest->u.l.l =  src1->u.l.l ^  imm; break;
	  case dill_jmp_lshi:  dest->u.i.i =  src1->u.i.i <<  imm; break;
	  case dill_jmp_lshu:  dest->u.u.u =  src1->u.u.u <<  imm; break;
	  case dill_jmp_lshul:  dest->u.ul.ul =  src1->u.ul.ul <<  imm; break;
	  case dill_jmp_lshl:  dest->u.l.l =  src1->u.l.l <<  imm; break;
	  case dill_jmp_rshi:  dest->u.i.i =  src1->u.i.i >>  imm; break;
	  case dill_jmp_rshu:  dest->u.u.u =  src1->u.u.u >>  imm; break;
...
void emulate_arith2(int code, struct reg_type *dest, struct reg_type *src)
{
    switch(code) {
	  ...
	  case dill_jmp_negu:  dest->u.u.u = -  src->u.u.u; break;
	  case dill_jmp_negul:  dest->u.ul.ul = -  src->u.ul.ul; break;
...
{
    switch(code) {
	  case dill_jmp_beqc:  return ( src1->u.c.c) ==  imm; break;
	  case dill_jmp_bequc:  return ( src1->u.uc.uc) ==  imm; break;
	  case dill_jmp_beqs:  return ( src1->u.s.s) ==  imm; break;
	  case dill_jmp_bequs:  return ( src1->u.us.us) ==  imm; break;
	  case dill_jmp_beqi:  return ( src1->u.i.i) ==  imm; break;
	  case dill_jmp_bequ:  return ( src1->u.u.u) ==  imm; break;
	  case dill_jmp_bequl:  return ( src1->u.ul.ul) ==  imm; break;
	  case dill_jmp_beql:  return ( src1->u.l.l) ==  imm; break;
	  case dill_jmp_beqp:  return ((char*) src1->u.p.p) == (char*) imm; break;
	  case dill_jmp_bgec:  return ( src1->u.c.c) >=  imm; break;
	  case dill_jmp_bgeuc:  return ( src1->u.uc.uc) >=  imm; break;
	  case dill_jmp_bges:  return ( src1->u.s.s) >=  imm; break;
	  case dill_jmp_bgeus:  return ( src1->u.us.us) >=  imm; break;
	  case dill_jmp_bgei:  return ( src1->u.i.i) >=  imm; break;
	  case dill_jmp_bgeu:  return ( src1->u.u.u) >=  imm; break;
	  case dill_jmp_bgeul:  return ( src1->u.ul.ul) >=  imm; break;
	  case dill_jmp_bgel:  return ( src1->u.l.l) >=  imm; break;
	  case dill_jmp_bgep:  return ((char*) src1->u.p.p) >= (char*) imm; break;
	  case dill_jmp_bgtc:  return ( src1->u.c.c) >  imm; break;
	  case dill_jmp_bgtuc:  return ( src1->u.uc.uc) >  imm; break;
	  case dill_jmp_bgts:  return ( src1->u.s.s) >  imm; break;
	  case dill_jmp_bgtus:  return ( src1->u.us.us) >  imm; break;
	  case dill_jmp_bgti:  return ( src1->u.i.i) >  imm; break;
	  case dill_jmp_bgtu:  return ( src1->u.u.u) >  imm; break;
	  case dill_jmp_bgtul:  return ( src1->u.ul.ul) >  imm; break;
	  case dill_jmp_bgtl:  return ( src1->u.l.l) >  imm; break;
	  case dill_jmp_bgtp:  return ((char*) src1->u.p.p) > (char*) imm; break;
	  case dill_jmp_blec:  return ( src1->u.c.c) <=  imm; break;
	  case dill_jmp_bleuc:  return ( src1->u.uc.uc) <=  imm; break;
	  case dill_jmp_bles:  return ( src1->u.s.s) <=  imm; break;
	  case dill_jmp_bleus:  return ( src1->u.us.us) <=  imm; break;
	  case dill_jmp_blei:  return ( src1->u.i.i) <=  imm; break;
	  case dill_jmp_bleu:  return ( src1->u.u.u) <=  imm; break;
	  case dill_jmp_bleul:  return ( src1->u.ul.ul) <=  imm; break;
	  case dill_jmp_blel:  return ( src1->u.l.l) <=  imm; break;
	  case dill_jmp_blep:  return ((char*) src1->u.p.p) <= (char*) imm; break;
	  case dill_jmp_bltc:  return ( src1->u.c.c) <  imm; break;
	  case dill_jmp_bltuc:  return ( src1->u.uc.uc) <  imm; break;
	  case dill_jmp_blts:  return ( src1->u.s.s) <  imm; break;
	  case dill_jmp_bltus:  return ( src1->u.us.us) <  imm; break;
	  case dill_jmp_blti:  return ( src1->u.i.i) <  imm; break;
	  case dill_jmp_bltu:  return ( src1->u.u.u) <  imm; break;
	  case dill_jmp_bltul:  return ( src1->u.ul.ul) <  imm; break;
	  case dill_jmp_bltl:  return ( src1->u.l.l) <  imm; break;
	  case dill_jmp_bltp:  return ((char*) src1->u.p.p) < (char*) imm; break;
	  case dill_jmp_bnec:  return ( src1->u.c.c) !=  imm; break;
	  case dill_jmp_bneuc:  return ( src1->u.uc.uc) !=  imm; break;
	  case dill_jmp_bnes:  return ( src1->u.s.s) !=  imm; break;
	  case dill_jmp_bneus:  return ( src1->u.us.us) !=  imm; break;
	  case dill_jmp_bnei:  return ( src1->u.i.i) !=  imm; break;
	  case dill_jmp_bneu:  return ( src1->u.u.u) !=  imm; break;
	  case dill_jmp_bneul:  return ( src1->u.ul.ul) !=  imm; break;
	  case dill_jmp_bnel:  return ( src1->u.l.l) !=  imm; break;
	  case dill_jmp_bnep:  return ((char*) src1->u.p.p) != (char*) imm; break;
    }return 0;
}
...
{
    switch(code) {
	case CONV(DILL_C, DILL_UC): dest->u.uc.uc = ((char)(0xff & src->u.l.l)); break;
	case CONV(DILL_C, DILL_S): dest->u.s.s = ((char)(0xff & src->u.l.l)); break;
	case CONV(DILL_C, DILL_US): dest->u.us.us = ((char)(0xff & src->u.l.l)); break;
	case CONV(DILL_C, DILL_I): dest->u.i.i = ((char)(0xff & src->u.l.l)); break;
	case CONV(DILL_C, DILL_U): dest->u.u.u = ((char)(0xff & src->u.l.l)); break;
	case CONV(DILL_C, DILL_UL): dest->u.ul.ul = ((char)(0xff & src->u.l.l)); break;
	case CONV(DILL_C, DILL_L): dest->u.l.l = ((char)(0xff & src->u.l.l)); break;
	case CONV(DILL_D, DILL_C): dest->u.c.c = src->u.d.d; break;
	case CONV(DILL_D, DILL_UC): dest->u.uc.uc = src->u.d.d; break;
	case CONV(DILL_D, DILL_S): dest->u.s.s = src->u.d.d; break;
	case CONV(DILL_D, DILL_US): dest->u.us.us = src->u.d.d; break;
	case CONV(DILL_D, DILL_I): dest->u.i.i = src->u.d.d; break;
	case CONV(DILL_D, DILL_U): dest->u.u.u = src->u.d.d; break;
	case CONV(DILL_D, DILL_UL): dest->u.ul.ul = src->u.d.d; break;
	case CONV(DILL_D, DILL_L): dest->u.l.l = src->u.d.d; break;
	case CONV(DILL_F, DILL_C): dest->u.c.c = src->u.f.f; break;
	case CONV(DILL_F, DILL_UC): dest->u.uc.uc = src->u.f.f; break;
	case CONV(DILL_F, DILL_S): dest->u.s.s = src->u.f.f; break;
	case CONV(DILL_F, DILL_US): dest->u.us.us = src->u.f.f; break;
	case CONV(DILL_F, DILL_I): dest->u.i.i = src->u.f.f; break;
	case CONV(DILL_F, DILL_U): dest->u.u.u = src->u.f.f; break;
	case CONV(DILL_F, DILL_UL): dest->u.ul.ul = src->u.f.f; break;
	case CONV(DILL_F, DILL_L): dest->u.l.l = src->u.f.f; break;
	case CONV(DILL_I, DILL_C): dest->u.c.c = ((int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_I, DILL_UC): dest->u.uc.uc = ((int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_I, DILL_S): dest->u.s.s = ((int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_I, DILL_US): dest->u.us.us = ((int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_I, DILL_U): dest->u.u.u = ((int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_I, DILL_UL): dest->u.ul.ul = ((int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_I, DILL_L): dest->u.l.l = ((int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_L, DILL_C): dest->u.c.c = src->u.l.l; break;
	case CONV(DILL_L, DILL_UC): dest->u.uc.uc = src->u.l.l; break;
	case CONV(DILL_L, DILL_S): dest->u.s.s = src->u.l.l; break;
	case CONV(DILL_L, DILL_US): dest->u.us.us = src->u.l.l; break;
	case CONV(DILL_L, DILL_I): dest->u.i.i = src->u.l.l; break;
	case CONV(DILL_L, DILL_U): dest->u.u.u = src->u.l.l; break;
	case CONV(DILL_L, DILL_UL): dest->u.ul.ul = src->u.l.l; break;
	case CONV(DILL_S, DILL_C): dest->u.c.c = ((short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_S, DILL_UC): dest->u.uc.uc = ((short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_S, DILL_US): dest->u.us.us = ((short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_S, DILL_I): dest->u.i.i = ((short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_S, DILL_U): dest->u.u.u = ((short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_S, DILL_UL): dest->u.ul.ul = ((short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_S, DILL_L): dest->u.l.l = ((short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_U, DILL_C): dest->u.c.c = ((unsigned int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_U, DILL_UC): dest->u.uc.uc = ((unsigned int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_U, DILL_S): dest->u.s.s = ((unsigned int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_U, DILL_US): dest->u.us.us = ((unsigned int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_U, DILL_I): dest->u.i.i = ((unsigned int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_U, DILL_UL): dest->u.ul.ul = ((unsigned int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_U, DILL_L): dest->u.l.l = ((unsigned int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_UL, DILL_C): dest->u.c.c = (long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_UC): dest->u.uc.uc = (long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_S): dest->u.s.s = (long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_US): dest->u.us.us = (long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_I): dest->u.i.i = (long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_U): dest->u.u.u = (long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_L): dest->u.l.l = (long)src->u.ul.ul; break;
	case CONV(DILL_US, DILL_C): dest->u.c.c = ((unsigned short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_US, DILL_UC): dest->u.uc.uc = ((unsigned short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_US, DILL_S): dest->u.s.s = ((unsigned short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_US, DILL_I): dest->u.i.i = ((unsigned short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_US, DILL_U): dest->u.u.u = ((unsigned short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_US, DILL_UL): dest->u.ul.ul = ((unsigned short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_US, DILL_L): dest->u.l.l = ((unsigned short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_UC, DILL_C): dest->u.c.c = ((unsigned char)(0xff & src->u.l.l)); break;
	case CONV(DILL_UC, DILL_S): dest->u.s.s = ((unsigned char)(0xff & src->u.l.l)); break;
	case CONV(DILL_UC, DILL_US): dest->u.us.us = ((unsigned char)(0xff & src->u.l.l)); break;
	case CONV(DILL_UC, DILL_I): dest->u.i.i = ((unsigned char)(0xff & src->u.l.l)); break;
	case CONV(DILL_UC, DILL_U): dest->u.u.u = ((unsigned char)(0xff & src->u.l.l)); break;
	case CONV(DILL_UC, DILL_UL): dest->u.ul.ul = ((unsigned char)(0xff & src->u.l.l)); break;
	case CONV(DILL_UC, DILL_L): dest->u.l.l = ((unsigned char)(0xff & src->u.l.l)); break;
	case CONV(DILL_C, DILL_F): dest->u.f.f = ((char)(0xff & src->u.l.l)); break;
	case CONV(DILL_C, DILL_D): dest->u.d.d = ((char)(0xff & src->u.l.l)); break;
	case CONV(DILL_UC, DILL_F): dest->u.f.f = ((unsigned char)(0xff & src->u.l.l)); break;
	case CONV(DILL_UC, DILL_D): dest->u.d.d = ((unsigned char)(0xff & src->u.l.l)); break;
	case CONV(DILL_S, DILL_F): dest->u.f.f = ((short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_S, DILL_D): dest->u.d.d = ((short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_US, DILL_F): dest->u.f.f = ((unsigned short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_US, DILL_D): dest->u.d.d = ((unsigned short)(0xffff & src->u.l.l)); break;
	case CONV(DILL_D, DILL_F): dest->u.f.f = src->u.d.d; break;
	case CONV(DILL_F, DILL_D): dest->u.d.d = src->u.f.f; break;
	case CONV(DILL_I, DILL_F): dest->u.f.f = ((int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_I, DILL_D): dest->u.d.d = ((int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_L, DILL_F): dest->u.f.f = src->u.l.l; break;
	case CONV(DILL_L, DILL_D): dest->u.d.d = src->u.l.l; break;
	case CONV(DILL_U, DILL_F): dest->u.f.f = ((unsigned int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_U, DILL_D): dest->u.d.d = ((unsigned int)(0xffffffff & src->u.l.l)); break;
	case CONV(DILL_UL, DILL_F): dest->u.f.f = (long)src->u.ul.ul; break;
	case CONV(DILL_UL, DILL_D): dest->u.d.d = (long)src->u.ul.ul; break;
	case CONV(DILL_P, DILL_UL): dest->u.ul.ul = src->u.l.l; break;
	case CONV(DILL_UL, DILL_P): dest->u.ul.ul = (long)src->u.ul.ul; break;
        default: printf("convert missed case %x \n", code); break;}
}
int emulate_loadi(int code, struct reg_type *dest, struct reg_type *src, long imm)
{
    switch(code) {
	case DILL_C: dest->u.l.l = (long) *((char*)(src->u.l.l + imm)); break;
	case DILL_D: dest->u.d.d = *((double*)(src->u.l.l + imm)); break;
	case DILL_F: dest->u.f.f = *((float*)(src->u.l.l + imm)); break;
	case DILL_I: dest->u.l.l = (long) *((int*)(src->u.l.l + imm)); break;
	case DILL_L: dest->u.l.l = (long) *((long*)(src->u.l.l + imm)); break;
	case DILL_S: dest->u.l.l = (long) *((short*)(src->u.l.l + imm)); break;
	case DILL_U: dest->u.l.l = (long) *((unsigned int *)(src->u.l.l + imm)); break;
	case DILL_UL: dest->u.l.l = (long) *((unsigned long *)(src->u.l.l + imm)); break;
	case DILL_US: dest->u.l.l = (long) *((unsigned short *)(src->u.l.l + imm)); break;
	case DILL_UC: dest->u.l.l = (long) *((unsigned char*)(src->u.l.l + imm)); break;
    }return 0;
}
int emulate_storei(int code, struct reg_type *dest, struct reg_type *src, long imm)
{
	...
	case DILL_L: *((long*)(src->u.l.l + imm)) = dest->u.l.l; break;
	case DILL_S: *((short*)(src->u.l.l + imm)) = dest->u.s.s; break;
	case DILL_U: *((unsigned int *)(src->u.l.l + imm)) = dest->u.u.u; break;
	case DILL_UL: *((unsigned long *)(src->u.l.l + imm)) = dest->u.ul.ul; break;
